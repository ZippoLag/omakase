...
| `conjugations/{aru,shokuji,kanzuru}.json` | **hand-derived [G] gap classes** per `conjugation-engine.md` §4.5/4.7 (v5r-i ある family, vs suru noun, vz) — not present in the upstream dataset; each file carries a `provenance` field | CC BY-SA 4.0 (our derivation) |
